		...
		<React.Fragment>
			<div className="about-container">
				<p className="about-para">
					...
					reading books, rollerblading, utilizing whitespace and indulging in UI
					design fundamentals. If you're having a rough day and keen on a good
					laugh, my coding journey blog can be found on
					<a
