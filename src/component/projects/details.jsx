...
export const details = [
  ...
  },
  {
    ...
    summary:
      " A very straightforward web application for a renovations company based in Bali, Indonesia made from scratch and on my own. This web application is statically-generated and hosted on Netlify with the use of HTML, CSS and React.js. I've always wanted to experiment with toggling before and after shots so this seemed like the perfect opportunity. ",
    description:
